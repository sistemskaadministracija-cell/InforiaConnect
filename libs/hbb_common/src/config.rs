...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("InforiaConnect".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["connect.inforia.si"];
pub const RS_PUB_KEY: &str = "kBRxXMzmxGFgnHkC3Z8pMgTWuITwkXpl6olOoVC2EFQ=";
