...
///
/// Note:
/// On linux, we use dbus to communicate multiple InforiaConnect process.
...
const DBUS_NAME: &str = "org.InforiaConnect.InforiaConnect";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "InforiaConnect DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.InforiaConnect.InforiaConnect /dbus org.InforiaConnect.InforiaConnect.NewConnection string:'PEER_ID'`
