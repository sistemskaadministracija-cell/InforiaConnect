...
impl TerminalSession {
    ...
    fn stop(&mut self) {
        ...
        //    `pty_pair` uses pipe. https://github.com/InforiaConnect-org/wezterm/blob/80174f8009f41565f0fa8c66dab90d4f9211ae16/pty/src/win/conpty.rs#L16
        //     `read()` may stuck at https://github.com/InforiaConnect-org/wezterm/blob/80174f8009f41565f0fa8c66dab90d4f9211ae16/filedescriptor/src/windows.rs#L345
        //     We can close the pipe to signal the reader thread to exit.
        //     After https://github.com/InforiaConnect-org/wezterm/blob/80174f8009f41565f0fa8c66dab90d4f9211ae16/pty/src/win/psuedocon.rs#L86, the reader reads `[27, 91, 63, 57, 48, 48, 49, 108, 27, 91, 63, 49, 48, 48, 52, 108]` in my tests.
        // 2. Linux
        //    `pty_pair` uses `libc::openpty`. https://github.com/InforiaConnect-org/wezterm/blob/80174f8009f41565f0fa8c66dab90d4f9211ae16/pty/src/unix.rs#L32
        //    We can also call the drop method first. https://github.com/InforiaConnect-org/wezterm/blob/80174f8009f41565f0fa8c66dab90d4f9211ae16/pty/src/unix.rs#L352
...
impl TerminalServiceProxy {
    ...
    fn handle_open_with_helper(
        ...
        let input_pipe_name = format!(r"\\.\pipe\InforiaConnect_term_in_{}", pipe_id);
        let output_pipe_name = format!(r"\\.\pipe\InforiaConnect_term_out_{}", pipe_id);
