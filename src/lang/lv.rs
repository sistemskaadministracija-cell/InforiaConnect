...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Notiek savienojuma izveide ar InforiaConnect tīklu..."),
        ...
        ("install_tip", "UAC dēļ InforiaConnect dažos gadījumos nevar pareizi darboties kā attālā puse. Lai izvairītos no UAC, lūdzu, noklikšķiniet uz tālāk esošās pogas, lai instalētu InforiaConnect sistēmā."),
        ("Click to upgrade", "Jaunināt"),
        ("Configure", "Konfigurēt"),
        ("config_acc", "Lai attālināti vadītu savu darbvirsmu, jums ir jāpiešķir InforiaConnect \"Pieejamība\" atļaujas."),
        ("config_screen", "Lai attālināti piekļūtu darbvirsmai, jums ir jāpiešķir InforiaConnect \"Ekrāna tveršana\" atļaujas."),
        ...
        ("android_input_permission_tip1", "Lai attālā ierīce varētu vadīt jūsu Android ierīci, izmantojot peli vai pieskārienu, jums ir jāatļauj InforiaConnect izmantot servisu \"Pieejamība\"."),
        ("android_input_permission_tip2", "Lūdzu, dodieties uz nākamo sistēmas iestatījumu lapu, atrodiet un atveriet [Instalētie pakalpojumi], ieslēdziet servisu [InforiaConnect Input]."),
        ...
        ("Turned off", "Izslēgts"),
        ("Language", "Valoda"),
        ("Keep InforiaConnect background service", "Saglabāt InforiaConnect fona servisu"),
        ("Ignore Battery Optimizations", "Ignorēt akumulatora optimizāciju"),
        ("android_open_battery_optimizations_tip", "Ja vēlaties atspējot šo funkciju, lūdzu, dodieties uz nākamo InforiaConnect lietojumprogrammas iestatījumu lapu, atrodiet un atveriet [Akumulators], noņemiet atzīmi no [Neierobežots]"),
        ...
        ("Show InforiaConnect", "Rādīt InforiaConnect"),
        ("This PC", "Šis dators"),
        ("or", "vai"),
        ("Elevate", "Pacelt"),
        ...
        ("config_input", "Lai vadītu attālo darbvirsmu ar tastatūru, jums ir jāpiešķir InforiaConnect \"Ievades uzraudzība\" atļaujas."),
        ("config_microphone", "Lai runātu attālināti, jums ir jāpiešķir InforiaConnect \"Ierakstīt audio\" atļaujas."),
        ...
        ("still_click_uac_tip", "Joprojām attālajam lietotājam ir jānoklikšķina uz Labi UAC logā, kurā darbojas InforiaConnect."),
        ...
        ("verify_InforiaConnect_password_tip", "Pārbaudīt InforiaConnect paroli"),
        ...
        ("scam_text1", "Ja sarunājaties ar kādu, kuru nepazīstat un kurš ir lūdzis izmantot InforiaConnect, lai sāktu pakalpojumu, neturpiniet un nekavējoties nolieciet klausuli."),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "Lūdzu, jauniniet InforiaConnect Server Pro uz versiju {} vai jaunāku!"),
        ...
        ("selinux_tip", "Jūsu ierīcē ir iespējots SELinux, kas var neļaut InforiaConnect pareizi darboties kā kontrolētajai pusei."),
        ...
        ("powered_by_me", "Darbojas ar InforiaConnect"),
        ...
        ("allow-only-conn-window-open-tip", "Atļaut savienojumu tikai tad, ja ir atvērts InforiaConnect logs"),
        ...
        ("floating_window_tip", "Tas palīdz uzturēt InforiaConnect fona servisu"),
        ...
        ("About InforiaConnect", "Par InforiaConnect"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "Lūdzu, jauniniet attālās puses InforiaConnect klientu uz versiju {} vai jaunāku!"),
