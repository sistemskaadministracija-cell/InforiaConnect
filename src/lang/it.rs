...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete InforiaConnect..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), InforiaConnect potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare InforiaConnect a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a InforiaConnect il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a InforiaConnect il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a InforiaConnect di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [InforiaConnect Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep InforiaConnect background service", "Mantieni il servizio di InforiaConnect in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione InforiaConnect, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show InforiaConnect", "Visualizza InforiaConnect"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a InforiaConnect 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a InforiaConnect."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di InforiaConnect."),
        ...
        ("verify_InforiaConnect_password_tip", "Conferma password InforiaConnect"),
        ...
        ("Exit", "Esci da InforiaConnect"),
        ("Open", "Apri InforiaConnect"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare InforiaConnect e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "Aggiorna InforiaConnect Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di InforiaConnect come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da InforiaConnect"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra InforiaConnect è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio InforiaConnect in background."),
        ...
        ("About InforiaConnect", "Info su InforiaConnect"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "Aggiorna il client InforiaConnect remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, InforiaConnect verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, InforiaConnect salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, InforiaConnect non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server InforiaConnect non include questa funzionalità."),
