...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "מוכן"),
        ("Established", "מחובר"),
        ("connecting_status", "מתחבר לרשת InforiaConnect..."),
        ...
        ("install_tip", "בגלל UAC, InforiaConnect לא יכול לפעול כראוי כצד מרוחק בחלק מהמקרים. כדי להימנע מ-UAC, אנא לחץ על הכפתור למטה כדי להתקין את InforiaConnect במערכת."),
        ("Click to upgrade", "לחץ כדי לשדרג"),
        ("Configure", "הגדר"),
        ("config_acc", "כדי לשלוט מרחוק בשולחן העבודה שלך, עליך להעניק ל-InforiaConnect הרשאות \"נגישות\"."),
        ("config_screen", "כדי לגשת מרחוק לשולחן העבודה שלך, עליך להעניק ל-InforiaConnect הרשאות \"הקלטת מסך\"."),
        ("Installing ...", "מתקין ..."),
        ("Install", "התקן"),
        ("Installation", "התקנה"),
        ...
        ("android_input_permission_tip1", "כדי שמכשיר מרוחק יוכל לשלוט במכשיר האנדרואיד שלך באמצעות עכבר או מגע, עליך לאפשר ל-InforiaConnect להשתמש בשירות \"נגישות\"."),
        ("android_input_permission_tip2", "אנא עבור לדף הגדרות המערכת הבא, מצא והכנס ל[שירותים מותקנים], הפעל את שירות [InforiaConnect Input]."),
        ...
        ("Turned off", "מכובה"),
        ("Language", "שפה"),
        ("Keep InforiaConnect background service", "השאר את שירות הרקע של InforiaConnect פעיל"),
        ("Ignore Battery Optimizations", "התעלם מאופטימיזציות סוללה"),
        ("android_open_battery_optimizations_tip", "אם ברצונך לבטל תכונה זו, אנא עבור לדף ההגדרות של יישום InforiaConnect , מצא והיכנס ל[סוללה], ובטל את הסימון מ-[לא מוגבל]"),
        ...
        ("Show InforiaConnect", "הצג את InforiaConnect"),
        ("This PC", "מחשב זה"),
        ("or", "או"),
        ...
        ("config_input", "כדי לשלוט בשולחן העבודה המרוחק באמצעות מקלדת, עליך להעניק ל-InforiaConnect הרשאות \"מעקב קלט\"."),
        ("config_microphone", "כדי לדבר מרחוק, עליך להעניק ל-InforiaConnect הרשאות \"הקלטת שמע\"."),
        ...
        ("still_click_uac_tip", "עדיין נדרש מהמשתמש המרוחק לאשר את חלון ה-UAC של InforiaConnect"),
        ...
        ("verify_InforiaConnect_password_tip", "אמת סיסמת InforiaConnect"),
        ...
        ("scam_text1", "אם אתה בשיחת טלפון עם מישהו שאינך מכיר ואינך סומך עליו שביקש ממך להשתמש ב-InforiaConnect ולהתחיל את השירות, אל תמשיך ונתק מיד."),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "אנא שדרג את InforiaConnect Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("selinux_tip", "SELinux מופעל במכשיר שלך, מה שעלול למנוע מ-InforiaConnect לפעול כראוי כצד הנשלט."),
        ...
        ("About InforiaConnect", "אודות InforiaConnect"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "אנא שדרג את לקוח InforiaConnect לגרסה {} או חדשה יותר בצד המרוחק!"),
