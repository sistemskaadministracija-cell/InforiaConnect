...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة InforiaConnect..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. InforiaConnect قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت InforiaConnect في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح InforiaConnect اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح InforiaConnect اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ InforiaConnect باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [InforiaConnect Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep InforiaConnect background service", "ابق خدمة InforiaConnect تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق InforiaConnect, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show InforiaConnect", "عرض InforiaConnect"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من InforiaConnect اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح InforiaConnect اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في InforiaConnect الذي يعمل."),
        ...
        ("verify_InforiaConnect_password_tip", "تحقق من كلمة مرور InforiaConnect"),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "ترقية خادم InforiaConnect Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع InforiaConnect"),
        ...
        ("About InforiaConnect", "حول InforiaConnect"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "ترقية عميل InforiaConnect البعيد إلى {}"),
