...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "S'està connectant a la xarxa de InforiaConnect..."),
        ...
        ("install_tip", "En alguns casos és possible que el InforiaConnect no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el InforiaConnect al vostre sistema."),
        ("Click to upgrade", "Feu clic per a actualitzar"),
        ("Configure", "Configura"),
        ("config_acc", "Per a poder controlar el dispositiu remotament, faciliteu al InforiaConnect els permisos d'accessibilitat."),
        ("config_screen", "Per a poder controlar el dispositiu remotament, faciliteu al InforiaConnect els permisos de gravació de pantalla."),
        ...
        ("android_input_permission_tip1", "Per a controlar de forma remota el vostre dispositiu amb gestos o un ratolí, heu de permetre al InforiaConnect l'ús del servei «Accessibilitat»."),
        ("android_input_permission_tip2", "A l'apartat Configuració del sistema de la pàgina següent, aneu a «Serveis baixats», i activeu el «InforiaConnect Input»."),
        ...
        ("Language", "Idioma"),
        ("Keep InforiaConnect background service", "Manté el servei del InforiaConnect en rerefons"),
        ("Ignore Battery Optimizations", "Ignora les optimitzacions de bateria"),
        ("android_open_battery_optimizations_tip", "Si voleu desactivar aquesta característica, feu-ho des de la pàgina següent de configuració del InforiaConnect, utilitzant l'opció relativa a «Bateria»"),
        ...
        ("elevated_foreground_window_tip", "La finestra de connexió actual requereix permisos ampliats per a funcionar i, de forma temporal, no es pot utilitzar ni el teclat ni el ratolí. Demaneu a l'usuari remot que minimitzi la finestra actual, o bé que faci clic al botó Permisos ampliats de la finestra d'administració de la connexió. Per a evitar aquest problema en un futur, instal·leu el InforiaConnect al dispositiu remot."),
        ...
        ("Show InforiaConnect", "Mostra el InforiaConnect"),
        ...
        ("config_input", "Per a poder controlar el dispositiu remotament amb el teclat, faciliteu al InforiaConnect els permisos d'entrada necessaris."),
        ("config_microphone", "Per a poder parlar remotament, faciliteu al InforiaConnect els permisos de gravació d'àudio necessaris."),
        ...
        ("still_click_uac_tip", "Es requereix acceptació manual a la part remota de la finestra «UAC» del InforiaConnect en execució."),
        ...
        ("verify_InforiaConnect_password_tip", "Verifica la contrasenya del InforiaConnect"),
        ...
        ("scam_text1", "Si cap persona qui NO coneixeu NI CONFIEU us demanés l'ús del InforiaConnect, no continueu i talleu la comunicació immediatament."),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "Actualitzeu el InforiaConnect Server Pro a la versió {} o superior!"),
        ...
        ("selinux_tip", "SELinux està activat al vostre dispositiu, la qual cosa evita que el InforiaConnect funcioni correctament com a equip controlable."),
        ...
        ("powered_by_me", "Amb la tecnologia de InforiaConnect"),
        ...
        ("allow-only-conn-window-open-tip", "Permet la connexió només si la finestra del InforiaConnect està activa"),
        ...
        ("floating_window_tip", "Ajuda a mantenir el servei del InforiaConnect en rerefons"),
        ...
        ("About InforiaConnect", "Quant al InforiaConnect"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", ""),
        ("d3d_render_tip", ""),
