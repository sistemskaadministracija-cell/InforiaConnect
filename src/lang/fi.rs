...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään InforiaConnect verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa InforiaConnect ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi InforiaConnectin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava InforiaConnectille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava InforiaConnectille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten InforiaConnect daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota InforiaConnectille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli InforiaConnect ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "InforiaConnect palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa InforiaConnectin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "InforiaConnect palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep InforiaConnect background service", "Pidä InforiaConnectin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista InforiaConnectin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show InforiaConnect", "Näytä InforiaConnect"),
        ...
        ("verify_InforiaConnect_password_tip", "Vahvista InforiaConnect salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "InforiaConnect ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "Päivitä InforiaConnect Server Pro versioon {} jatkaaksesi."),
        ...
        ("About InforiaConnect", "Tietoa InforiaConnectistä"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "Päivitä etä-InforiaConnect-asiakasversioon {} yhteensopivuuden takaamiseksi"),
