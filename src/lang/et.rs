...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "InforiaConnecti võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa InforiaConnect mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et InforiaConnect oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb InforiaConnectile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb InforiaConnectile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma InforiaConnectile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [InforiaConnect Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep InforiaConnect background service", "Säilita InforiaConnecti taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele InforiaConnecti rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show InforiaConnect", "Kuva InforiaConnect"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma InforiaConnectile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma InforiaConnectile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud InforiaConnecti kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_InforiaConnect_password_tip", "Kinnita InforiaConnecti parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul InforiaConnecti kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "Palun täienda InforiaConnect Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib InforiaConnectil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb InforiaConnectil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui InforiaConnecti aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada InforiaConnecti taustateenust."),
        ...
        ("About InforiaConnect", "InforiaConnecti teave"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "Täiendage InforiaConnecti klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
