...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het InforiaConnect netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer InforiaConnect op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u InforiaConnect toestemming voor Toegankelijkheid geven."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u InforiaConnect toestemming voor Schermopname geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u InforiaConnect toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [InforiaConnect Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep InforiaConnect background service", "InforiaConnect achtergronddienst behouden"),
        ...
        ("Show InforiaConnect", "Toon InforiaConnect"),
        ("This PC", "Deze PC"),
        ("or", "of"),
        ("Elevate", "Verhoog"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u InforiaConnect toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u InforiaConnect toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende InforiaConnect."),
        ...
        ("verify_InforiaConnect_password_tip", "Bevestiging wachtwoord InforiaConnect"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om InforiaConnect te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "Upgrade InforiaConnect Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor InforiaConnect mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("powered_by_me", "Werkt met InforiaConnect"),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het InforiaConnect-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt InforiaConnect op de achtergrond actief te houden"),
        ...
        ("About InforiaConnect", "Over InforiaConnect"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "Upgrade de InforiaConnect client naar versie {} of nieuwer op de externe computer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standaard controleert InforiaConnect het certificaat van de server bij het gebruik van protocollen die TLS gebruiken. Wanneer deze optie is ingeschakeld, laat InforiaConnect verbindingen toe, zelfs als de verificatiestap mislukt."),
        ("Disable UDP", "UDP uitschakelen"),
        ("disable-udp-tip", "Controleert of alleen TCP moet worden gebruikt. Als deze optie is ingeschakeld, gebruikt InforiaConnect niet langer UDP 21116, maar TCP 21116."),
        ("server-oss-not-support-tip", "Opmerking: Deze functie is niet beschikbaar in de open-sourceversie van de InforiaConnect-server."),
