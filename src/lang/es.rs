...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red InforiaConnect en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que InforiaConnect no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar InforiaConnect a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a InforiaConnect de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a InforiaConnect de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que InforiaConnect use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [InforiaConnect Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep InforiaConnect background service", "Dejar InforiaConnect como Servicio en 2do plano"),
        ...
        ("Show InforiaConnect", "Mostrar InforiaConnect"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a InforiaConnect permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a InforiaConnect permisos de \"Grabar Audio\"."),
        ...
        ("verify_InforiaConnect_password_tip", "Verificar la contraseña de InforiaConnect"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses InforiaConnect e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "¡Por favor, actualiza InforiaConnect Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que InforiaConnect no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de InforiaConnect"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de InforiaConnect de fondo"),
        ...
        ("About InforiaConnect", "Acerca de InforiaConnect"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "Por favor, actualiza el cliente InforiaConnect a la versión {} o superior en el lado remoto"),
        ...
        ("allow-insecure-tls-fallback-tip", "De forma predeterminada, InforiaConnect verifica el certificado de servidor para protocolos que usen TLS.\nCon esta opción habilitada, InforiaConnect volverá al paso de omisión de verificación y procederá en caso de fallo de verificación."),
        ("Disable UDP", "Inhabilitar UDP"),
        ("disable-udp-tip", "Controla si se usa TCP solamente.\nCuando esta opción está activa, InforiaConnect no usará más el puerto UDP 21116, en su lugar se usará el TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: El servidor InforiaConnect OSS no incluye esta característica."),
