...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "InforiaConnect może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować InforiaConnect w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić InforiaConnect przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić InforiaConnect na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [InforiaConnect Input]."),
        ...
        ("Language", "Język"),
        ("Keep InforiaConnect background service", "Zachowaj usługę InforiaConnect w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji InforiaConnect, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show InforiaConnect", "Pokaż InforiaConnect"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji InforiaConnect uprawnień do \"Urządzeń Wejściowych\"."),
        ("config_microphone", "Aby umożliwić zdalne rozmowy należy przyznać InforiaConnect uprawnienia do \"Nagrań audio\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z InforiaConnect w Twojej sieci."),
        ...
        ("verify_InforiaConnect_password_tip", "Weryfikuj hasło InforiaConnect"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu InforiaConnect - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "Proszę zaktualizować InforiaConnect Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu InforiaConnect po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez InforiaConnect"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno InforiaConnect jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę InforiaConnect w tle"),
        ...
        ("About InforiaConnect", "O programie"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "Proszę zaktualizować zdalny klient InforiaConnect do wersji {} lub nowszej!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Domyślnie InforiaConnect weryfikuje certyfikat serwera dla protokołów korzystających z TLS.\n Po włączeniu tej opcji, InforiaConnect pominie etap weryfikacji i będzie kontynuował działanie w przypadku negatywnej weryfikacji."),
        ("Disable UDP", "Wyłącz protokół UDP"),
        ("disable-udp-tip", "Kontroluje, czy używać wyłącznie protokołu TCP.\nPo włączeniu tej opcji, InforiaConnect nie będzie używać protokołu UDP 21116, zamiast niego będzie używać protokołu TCP 21116."),
        ("server-oss-not-support-tip", "UWAGA: Serwer OSS InforiaConnect nie obsługuje tej funkcji."),
