...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione a sa rete InforiaConnect..."),
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), InforiaConnect diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare InforiaConnect a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a InforiaConnect su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a InforiaConnect su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a InforiaConnect de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada InforiaConnect]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep InforiaConnect background service", "Mantene su servìtziu de InforiaConnect in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione InforiaConnect, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("Show InforiaConnect", "Mustra InforiaConnect"),
        ("This PC", "Custu PC"),
        ("or", "O"),
        ("Elevate", "Cresche"),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a InforiaConnect sos permissos de 'Monitoràgiu insertada'."),
        ("config_microphone", "Per pòdere mutire, bisòngiat a frunire su premissu 'Registra àudio' a InforiaConnect."),
        ...
        ("still_click_uac_tip", "Torra a pedire chi s'utente remotu seletziones 'AB' in sa ventana UAC de s'esecutzione de InforiaConnect."),
        ...
        ("verify_InforiaConnect_password_tip", "Cunfirma sa crae de InforiaConnect"),
        ...
        ("Exit", "Essi dae InforiaConnect"),
        ("Open", "Aberi InforiaConnect"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare InforiaConnect e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "Atualiza InforiaConnect Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de InforiaConnect comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae InforiaConnect"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana InforiaConnect est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de InforiaConnect"),
        ...
        ("About InforiaConnect", "Informatziones subra de InforiaConnect"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "Atualiza su cliente InforiaConnect remotu a sa versione {} o prus noa!"),
