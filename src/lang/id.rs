...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke InforiaConnect..."),
        ...
        ("install_tip", "Karena UAC, InforiaConnect tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal InforiaConnect ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk InforiaConnect."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk InforiaConnect."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd InforiaConnect untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input InforiaConnect]."),
        ...
        ("Language", "Bahasa"),
        ("Keep InforiaConnect background service", "Pertahankan InforiaConnect berjalan pada service background"),
        ...
        ("Show InforiaConnect", "Tampilkan InforiaConnect"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada InforiaConnect"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada InforiaConnect"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC InforiaConnect yang sedang berjalan"),
        ...
        ("verify_InforiaConnect_password_tip", "Verifikasi Kata Sandi InforiaConnect"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan InforiaConnect, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "Silahkan perbarui InforiaConnect Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah InforiaConnect berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh InforiaConnect"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela InforiaConnect sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service InforiaConnect agar tetap aktif"),
        ...
        ("About InforiaConnect", "Tentang InforiaConnect"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "Silahkan perbarui aplikasi InforiaConnect ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
