...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "कृपया सिस्टम सेटिंग में InforiaConnect खोजें और इसे चालू करें।"),
        ...
        ("Language", "भाषा"),
        ("Keep InforiaConnect background service", "InforiaConnect बैकग्राउंड सेवा चालू रखें"),
        ...
        ("Show InforiaConnect", "InforiaConnect दिखाएं"),
        ("This PC", "यह PC"),
        ("or", "या"),
        ...
        ("verify_InforiaConnect_password_tip", "InforiaConnect पासवर्ड सत्यापित करें"),
        ...
        ("scam_text1", "यदि आप किसी ऐसे व्यक्ति से बात कर रहे हैं जिसे आप नहीं जानते और जिसने आपसे InforiaConnect उपयोग करने को कहा है, तो तुरंत डिस्कनेक्ट कर दें।"),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "InforiaConnect सर्वर प्रो को संस्करण {} में अपग्रेड करें"),
        ...
        ("allow-only-conn-window-open-tip", "केवल तभी कनेक्शन की अनुमति दें जब InforiaConnect विंडो खुली हो"),
        ...
        ("floating_window_tip", "बैकग्राउंड में रहने के दौरान InforiaConnect को दिखाएं"),
        ...
        ("About InforiaConnect", "InforiaConnect के बारे में"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "रिमोट InforiaConnect क्लाइंट को संस्करण {} में अपग्रेड करें"),
