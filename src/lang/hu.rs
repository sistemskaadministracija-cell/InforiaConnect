...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használatakor. A megfelelő működés érdekében, telepítse a InforiaConnect alkalmazást a számítógépére."),
        ("Click to upgrade", "Kattintson ide a frissítés telepítéséhez"),
        ("Configure", "Beállítás"),
        ("config_acc", "A számítógép távoli vezérléséhez a InforiaConnectnek hozzáférési jogokat kell adnia."),
        ("config_screen", "Ahhoz, hogy távolról hozzáférhessen a számítógépéhez, meg kell adnia a InforiaConnectnek a „Képernyőfelvétel” jogosultságot."),
        ...
        ("android_input_permission_tip1", "Ahhoz, hogy egy távoli eszköz vezérelhesse Android készülékét, engedélyeznie kell a InforiaConnect számára a „Hozzáférhetőség” szolgáltatás használatát."),
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a „InforiaConnect Input” szolgáltatást."),
        ...
        ("Language", "Nyelv"),
        ("Keep InforiaConnect background service", "InforiaConnect futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívül hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a InforiaConnect alkalmazás beállításaiba, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ...
        ("Show InforiaConnect", "A InforiaConnect megjelenítése"),
        ...
        ("config_input", "Ahhoz, hogy a távoli asztalt a billentyűzettel vezérelhesse, a InforiaConnectnek meg kell adnia a „Bemenet figyelése” jogosultságot."),
        ("config_microphone", "Ahhoz, hogy távolról beszélhessen, meg kell adnia a InforiaConnectnek a „Hangfelvétel” jogosultságot."),
        ...
        ("still_click_uac_tip", "A távoli felhasználónak továbbra is az „Igen” gombra kell kattintania a InforiaConnect UAC ablakában. Kattintson!"),
        ...
        ("verify_InforiaConnect_password_tip", "InforiaConnect jelszó megerősítése"),
        ...
        ("scam_text1", "Ha olyan valakivel beszél telefonon, akit NEM ISMER, akiben NEM BÍZIK MEG, és aki arra kéri, hogy használja a InforiaConnectet és indítsa el a szolgáltatást, ne folytassa, és azonnal tegye le a telefont."),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "Frissítse a InforiaConnect Server Prot a(z) {} vagy újabb verzióra!"),
        ...
        ("selinux_tip", "A SELinux engedélyezve van az eszközén, ami azt okozhatja, hogy a InforiaConnect nem fut megfelelően, mint ellenőrzött."),
        ...
        ("powered_by_me", "Üzemeltető: InforiaConnect"),
        ("outgoing_only_desk_tip", "Ez a InforiaConnect testre szabott kimenete.\nMás eszközökhöz kapcsolódhat, de más eszközök nem kapcsolódhatnak az Ön eszközéhez."),
        ("preset_password_warning", "Ez egy testre szabott kimenet a InforiaConnectből egy előre beállított jelszóval. Bárki, aki ismeri ezt a jelszót, teljes irányítást szerezhet a készülék felett. Ha nem kívánja ezt megtenni, azonnal távolítsa el ezt a szoftvert."),
        ...
        ("allow-only-conn-window-open-tip", "Csak akkor engedélyezze a kapcsolódást, ha a InforiaConnect ablaka nyitva van."),
        ...
        ("floating_window_tip", "Segít, ha a InforiaConnect a háttérben fut."),
        ...
        ("About InforiaConnect", "A InforiaConnect névjegye"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "Frissítse a InforiaConnect klienst {} vagy újabb verziójára a távoli oldalon!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Alapértelmezés szerint a InforiaConnect ellenőrzi a kiszolgáló tanúsítványát a TLS-protokollok esetében. Ha ez a beállítás engedélyezve van, a InforiaConnect kihagyja az ellenőrzési lépést, és az ellenőrzés sikertelensége esetén folytatja a műveletet."),
        ("Disable UDP", "UDP letiltása"),
        ("disable-udp-tip", "Meghatározza, hogy csak TCP-t használjon-e. Ha ez az beállítás engedélyezve van, a InforiaConnect nem fogja többé használni a 21116-os UDP-portot, helyette a 21116-os TCP-portot fogja használni."),
        ("server-oss-not-support-tip", "MEGJEGYZÉS: Az OSS InforiaConnect kiszolgáló nem támogatja ezt a funkciót."),
