...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem InforiaConnect..."),
        ...
        ("Blocked by administrator", "Blokirano s strani skrbnika"),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, InforiaConnect v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate InforiaConnectu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate InforiaConnectu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno InforiaConnectu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »InforiaConnect Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep InforiaConnect background service", "Ohrani InforiaConnectovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije InforiaConnect, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "InforiaConnect potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "InforiaConnect potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_InforiaConnect_password_tip", "Preveri geslo za InforiaConnect"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite InforiaConnect, prekinite klic in program zaprite."),
        ("scam_text2", "InforiaConnect omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "Prosimo, nadgradite InforiaConnect Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo InforiaConnect"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno InforiaConnecta odprto"),
        ...
        ("floating_window_tip", "Pomaga pri InforiaConnect storitvi v ozadju"),
        ...
        ("About InforiaConnect", "O InforiaConnectu"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "Prosimo, nadgradite InforiaConnect odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
