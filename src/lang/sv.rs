...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till InforiaConnect..."),
        ...
        ("install_tip", "På grund av UAC, kan inte InforiaConnect fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera InforiaConnect på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge InforiaConnect \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge InforiaConnect \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [InforiaConnect Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep InforiaConnect background service", "Behåll InforiaConnect i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa InforiaConnect programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show InforiaConnect", "Visa InforiaConnect"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),
