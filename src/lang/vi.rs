...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới InforiaConnect..."),
        ...
        ("install_tip", "Do cơ chế UAC, InforiaConnect có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt InforiaConnect vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho InforiaConnect."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho InforiaConnect."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [InforiaConnect Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep InforiaConnect background service", "Giữ dịch vụ InforiaConnect chạy nền"),
        ...
        ("Show InforiaConnect", "Hiện InforiaConnect"),
        ...
        ("verify_InforiaConnect_password_tip", "Xác thực mật khẩu InforiaConnect"),
        ...
        ("scam_text2", "Chỉ sử dụng InforiaConnect với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_InforiaConnect_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ InforiaConnect mở"),
        ...
        ("floating_window_tip", "Giữ InforiaConnect trên cùng"),
        ...
        ("About InforiaConnect", "Về InforiaConnect"),
        ...
        ("upgrade_remote_InforiaConnect_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
